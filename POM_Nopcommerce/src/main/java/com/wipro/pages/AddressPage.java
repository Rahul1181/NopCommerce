...
public class AddressPage extends TestBase {
	//Webelement path to fill the address details
	...
	//Validate the address path
	public boolean ValidateAddress(String fName, String lName, String eml, String cName, String citys,
			String add1, String add2, String zCode, String pNumber) {
		...
		//Check if address details are executed or not 
		try {
